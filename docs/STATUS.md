...
简化版 UI 已移植到真实应用(hero 卡 + 单行提醒条 + 扁平细描边卡片)。下一步:P3 迭代 3「净资产总览 + 月度报告」(见路线图)。
...
- 测试:47 E2E(TC-N 3 / TC-T 7 / TC-O 5 / TC-B 5 / TC-F 7 / TC-A 4 / TC-BG 5 / TC-RC 5 / TC-AU 6)+ 7 单测,最近一次全绿;报告见 [测试报告.md](测试报告.md)(`npm run test:doc` 生成)
