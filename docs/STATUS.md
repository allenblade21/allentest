...
P4「AI 财务问答」已完成(/ask,复用 OCR provider 配置)。P4 剩余:离线壳、通知推送、自动记账(见路线图)。
...
- 测试:65 E2E(+TC-AI 3;+TC-PW 3;+TC-AX 4;TC-N 3 / TC-T 7 / TC-O 5 / TC-B 5 / TC-F 7 / TC-A 4 / TC-BG 5 / TC-RC 5 / TC-AU 6 / TC-NW 3 / TC-RP 5)+ 7 单测,最近一次全绿;报告见 [测试报告.md](测试报告.md)(`npm run test:doc` 生成)
- 数据表:11;E2E 用例组:11
